...
#会社名の抽出２（悪いことを行った会社の抽出）
            ...
            ・悪事を働いたり不祥事を起こした会社名を抽出します。
            ・被害をうけた会社や、悪事や不祥事に関係ない会社は抽出しないでください。
            ・悪事を働いたり加担した可能性があって判断が難しい場合は、会社名を抽出し、会社名の最後に"（悪事／不祥事の可能性あり）"を追加してください。
            ・記事には本文の他にアクセスランキングや広告がありますが、本文からのみ会社名を抽出してください。
            ・会社名が20社以上の場合は20社目まで出力してください。
...
#            company_name = response["choices"][0]["message"]
            ...
            st.write("========================================================================================")
            st.write("３．悪事を働いた／不祥事を起こした会社（最大20社）")
